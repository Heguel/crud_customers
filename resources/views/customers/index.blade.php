        ...
        <div class="col-md-8">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-3">
                            <a href="{{ route('customers.create') }}" class="btn" style="background-color: #4643d3; color: white;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="javascript:;" onclick="$('.form-{{ $customer->id }}').submit()" style="color: #2c2c2c;" class="ms-1 me-1"><i
