            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <a href="{{ route('customers.index') }}" class="btn" style="background-color: #4643d3; color: white;">
                    ...
                    <table class="table table-bordered" style="border: 1px solid #dddddd">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('customers.restore', $customer->id)}}" style="color: #2c2c2c;" class="ms-1 me-1"><i
                                            class="fas fa-redo"></i></a>
                                    {{-- <a href="{{ route('customers.show', $customer->id) }}" style="color: #2c2c2c;" class="ms-1 me-1"><i
                                            class="far fa-eye"></i></a> --}}
                                    <a href="javascript:;" onclick="if(confirm('Are you sure you want to delete this customer permanently?')) $('.form-{{ $customer->id }}').submit()" style="color: #2c2c2c;" class="ms-1 me-1"><i
                                            class="fas fa-trash-alt"></i></a>
                                    <form class="form-{{ $customer->id }}" action="{{ route('customers.deletePermanently', $customer->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                </td>
